...
class RecargaAtt extends StatefulWidget {
  @override
  _RecargaAttState createState() => _RecargaAttState();
}

class _RecargaAttState extends State<RecargaAtt> {
          ...
          child: Column(
            children: <Widget>[
              ...
              Container(
                ...
                child: Image(image: AssetImage('assets/img/att.png'), fit: BoxFit.cover),
  ...
  Widget _ponerSubtitulo(){
    return Container(
      margin: EdgeInsets.symmetric(horizontal: 120.0, vertical: 90.0),
      child: Text('==Venta ATT==', style: GoogleFonts.benchNine(
        color: Colors.white,
        fontSize: 30.0,
        fontWeight: FontWeight.bold
      ))
