...
class RecargaMovistar extends StatefulWidget {
  @override
  _RecargaMovistarState createState() => _RecargaMovistarState();
}

class _RecargaMovistarState extends State<RecargaMovistar> {
          ...
          child: Column(
            children: <Widget>[
              ...
              Container(
                ...
                child: Image(image: AssetImage('assets/img/movistar.png'), fit: BoxFit.cover),
  ...
  _saveDatos(BuildContext context) async {
    ...
    if(num1 == num2){
      ...
      recargasModel.compania = 'Movistar';
  ...
  Widget _ponerSubtitulo(){
    return Container(
      margin: EdgeInsets.symmetric(horizontal: 97.0, vertical: 90.0),
      child: Text('==Venta Movistar==', style: GoogleFonts.benchNine(
        color: Colors.white,
        fontSize: 30.0,
        fontWeight: FontWeight.bold
      ))
